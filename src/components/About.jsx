...
function MailIcon() {
  return (
    <svg className="about__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
function DouyinIcon() {
  return (
    <svg className="about__icon" viewBox="0 0 24 24" fill="currentColor">
      <path d="M17.375 2.043a4.488 4.488 0 0 0 1.088 2.494 5.014 5.014 0 0 0 2.416 1.608v3.38a8.34 8.34 0 0 1-4.096-1.095v4.97a6.676 6.676 0 1 1-5.537-6.56v3.72a3.34 3.34 0 1 0 2.272 3.168V2.04h3.857Z" />
    </svg>
  );
}
...
function XiaohongshuIcon() {
  return (
    <svg className="about__icon" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <main className="about">
      ...
      <section className="about__section container">
        <div className="about__section-header">
          <span className="about__section-marker">✦</span>
      ...
      <footer className="about__footer">
        <div className="container">
          ...
          <p className="about__footer-text">
            &copy; {new Date().getFullYear()} RAW GRAIN &middot; ALL RIGHTS RESERVED
          </p>
        </div>
      </footer>
    </main>
